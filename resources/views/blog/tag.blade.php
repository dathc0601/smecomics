...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <header class="text-center mb-12 relative">
        <div class="absolute inset-0 -z-10 overflow-hidden">
            <div class="absolute top-0 left-1/4 w-72 h-72 bg-peach-300/30 rounded-full blur-3xl"></div>
            <div class="absolute bottom-0 right-1/4 w-96 h-96 bg-orange-manga-300/30 rounded-full blur-3xl"></div>
        </div>
        ...
        <div class="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-peach-500 to-orange-manga-500 rounded-2xl shadow-lg mb-6">
            <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 20l4-16m2 16l4-16M6 9h14M4 15h14"></path>
            </svg>
        </div>
        <h1 class="text-4xl md:text-5xl font-extrabold text-gray-900 mb-4 tracking-tight">
            <span class="text-transparent bg-clip-text bg-gradient-to-r from-peach-500 to-orange-manga-500">#</span>{{ $tag->name }}
        </h1>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2">
                ...
                <article class="group bg-white rounded-2xl shadow-md overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                    <a href="{{ route('blog.show', $post) }}" class="block">
                        <div class="aspect-video overflow-hidden">
                            ...
                            @else
                                <div class="w-full h-full bg-gradient-to-br from-peach-200 to-orange-manga-200 flex items-center justify-center">
            ...
            <div class="text-center py-16 bg-white rounded-2xl shadow-md">
                ...
                <h3 class="text-xl font-bold text-gray-600 mb-2">No posts with this tag</h3>
        ...
        <aside class="lg:col-span-1 space-y-8">
            ...
            <!-- Explore Manga CTA -->
            <div class="bg-gradient-to-br from-peach-500 to-orange-manga-500 rounded-2xl shadow-lg p-6 text-white text-center">
                <h3 class="text-lg font-bold mb-2">Love Manga?</h3>
                <p class="text-white/80 text-sm mb-4">Explore our collection of manga and manhwa.</p>
